...
// import { API_SORT_OPTIONS_, DEFAULT_SORT_OPTION } from "../api/api";
...
//   sortBy: (typeof API_SORT_OPTIONS_)[number]["value"];
//   page: number;
// }
...
//     setSortBy: (
//       state,
//       action: PayloadAction<(typeof API_SORT_OPTIONS_)[number]["value"] | null>
//     ) => {
//       state.page = 1;
